function params = post_fc_processing_mixed_batch_params_iNetworks
%
...
% datalist_loc = '/gpfs/research/grattonlab/member_directories/nrl18/GrattonLab-General-Repo-master/SurfacePipeline/'; % subj '_mixed_Datalist_fmriprep-20.2.0.txt']; % change this to datalist for your project
% datalist_suffix= '_mixed_Datalist_fmriprep-20.2.0.txt';
...
fcprocessed_funcdata_dir = '/projects/b1081/Lifespan/Nifti/derivatives/preproc_fmriprep-20.2.0/fmriprep/';
...
fs_LR_surfdir = '/projects/b1081/Lifespan/Nifti/derivatives/freesurfer-6.0.1/FREESURFER_fs_LR/';
