...
% tmp = corrmat_2(3,:,:,:);
% corrlin(3,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_3(1,:,:,:);
% corrlin(4,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_3(2,:,:,:);
% corrlin(5,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_3(3,:,:,:);
% corrlin(6,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_3(4,:,:,:);
% corrlin(7,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_3(5,:,:,:);
% corrlin(8,:) = single(FisherTransform(tmp(maskmat)));
% tmp = mean_LS04;
% corrlin(9,:) = tmp(maskmat);
% tmp = corrmat_5(1,:,:,:);
% corrlin(9,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_5(2,:,:,:);
% corrlin(10,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_5(3,:,:,:);
% corrlin(11,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_5(4,:,:,:);
% corrlin(12,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_5(5,:,:,:);
% corrlin(13,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_7(1,:,:,:);
% corrlin(14,:) = single(FisherTransform(tmp(maskmat)));
% tmp = corrmat_7(2,:,:,:);
