...
system([workbenchdir '/wb_command -cifti-create-dense-scalar ' volfile '_LR_surf_subcort_333_32k_fsLR.dscalar.nii -volume ' volfile '.nii.gz ' maskdir ' -left-metric ' timename_L ' -roi-left ' medial_mask_L ' -right-metric ' timename_R ' -roi-right ' medial_mask_R ]);
