...
%surface_parcellation_singlesub(subject,dconnfile,surfdir,subsample,dosubcort,outputdir)
%
...
randinds = sort(randinds(1:num_samples),'ascend');
dlmwrite('randinds.txt',randinds(:))
