...
thresholdarray = [0.003 0.004 0.005:0.005:0.05];%[0.003 0.004 0.005:0.005:0.05];
...
tmp.data = outmat;
ft_write_cifti_mod([str '_conBensus_weighted_minsize' num2str(minNetSize) '_consecutive.dtseries.nii'], tmp);
