function PostFreeSurferPipeline_fsavg2fslr_long_thickness_GrattonLab(subject,FreesurferImportLocation,MPRImportLocation)
...
ResampleFolder = [outputFolder '/thickness/sub-' subject '/' ResampleAtlasName ];
if ~exist(ResampleFolder)
...
surfaces = {'thickness'}; %CG - inflated and very inflated don't work with applying the transforms; regenerate afterward too
